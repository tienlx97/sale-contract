...
const body = {
  ...
  contract: {
    ...
    paymentAppend: [
      {
        title:
          'The final payment (Upon Delivery in Canada): The remaining 5% balance shall be paid by Party A to Party B upon successful delivery of the goods to the destination in Canada.',
  ...
  articleTermination: {
    ...
    block: [
      { type: 'paragraph', level: 1, text: 'The contract shall be terminated before the expiry in the following cases:' },
      {
        type: 'list',
        level: 2, // sẽ ra (i), (ii), (iii) theo numbering của bạn
        items: [
          'Party A is declared bankrupt or becomes insolvent',
          'Party B is declared bankrupt or becomes insolvent.',
          'If more than {{lateDays}} ({{lateDaysNum}}) days have passed since the payment due date specified in Article 4.2 of this Contract, and Party B has issued a formal written notice to Party A regarding such delay, but Party A still fails to make payment, then Party B reserves the right to unilaterally terminate this Contract.',
        ],
      },
      {
        type: 'paragraph',
    ...
    block: [
      {
        ...
        level: 1,
        children: [
          'After party A completes all payments to party B stated in the contract and the project is taken over and when party B fulfills the responsibility for Steel Structure warranty as stated at article 7, the contract is considered liquidated.',
        ],
      },
    ],
  },
    ...
    block: [
      {
        ...
        level: 1,
        children: [
          'Neither party shall be liable to fulfill any obligation under this Contract if such obligation becomes impossible or unreasonably difficult to perform due to force majeure, including but not limited to war, severe fire, flood, typhoon, earthquake, riots, civil disturbances, embargo, government regulations or orders, vessel congestion, or any circumstances beyond the control of the parties.',
          'In case the goods are subject to customs inspection, all related costs shall be borne by the Consignee (Party A).',
          'Either party being affected by such an event of force majeure shall give written notice to the other party immediately of the occurrence mentioned above and within fourteen days thereafter, the Seller shall send by airmail to the Buyer for their acceptance of a certificate of the event issued by the Competent Government Authorities where the event occurs as evidence thereof.',
          'Should such event of force majeure continue for more than 10 weeks, either party hereto shall have the right to cancel this contract by giving 15 days prior notice.',
          'In case of customs inspection required by authorities at the port of departure, and such inspection is not due to Party B’s fault, all related costs incurred shall be borne by the Consignee (Party A)',
        ],
      },
    ],
  },
    ...
    block: [
      {
        type: 'paragraph',
        level: 1,
        children: ['This Contract shall be governed by the prevailing laws of the Socialist Republic of Vietnam.'],
      },
      {
        type: 'paragraph',
        level: 1,
      ...
      },
      {
        ...
        level: 1,
        children: [
          'Both parties undertake to correctly execute the articles in the contract in good faith. All amendments, supplements shall be agreed in writing by both parties. The amendment and supplementary part is an integral part of the contract.',
        ],
      },
      {
        type: 'paragraph',
        level: 1,
        children: ['The contract is signed in English language.'],
      },
      {
        type: 'paragraph',
        level: 1,
        children: [
          'This contract is made into 02 sets (original) in English, 02 sets of the same value for each party in witness hereof. This Contract shall become effective as of the date of signature by both parties.',
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        children: [
          ...
          //   children: [
          //     new TextRun({
          //       text: '- There is a destructive action for any reason.',
          //     }),
          //   ],
          // }),
          // new Paragraph({
          ...
          //   children: [
          //     new TextRun({
          //       text: '- Party A or the third Party be undertakes dismantling or relocation by itself, resulting in damages not covered under this Contract.',
          //     }),
          //   ],
          // }),
          // new Paragraph({
          ...
          //   children: [
          //     new TextRun({
          //       text: '- Party A does not pay under the Contract.',
          //     }),
          //   ],
          // }),
          // //
          ...
          //   children: [
          //     new TextRun({
          //       text: 'Party A is declared bankrupt or becomes insolvent',
          //     }),
          //   ],
          // }),
          // new Paragraph({
          ...
          //   children: [
          //     new TextRun({
          //       text: 'Party B is declared bankrupt or becomes insolvent.',
          //     }),
          //   ],
          // }),
          // new Paragraph({
          ...
          //   children: [
          //     new TextRun({
          //       text: 'If more than sixty (60) days have passed since the payment due date specified in Article 4.2 of this Contract, and Party B has issued a formal written notice to Party A regarding such delay, but Party A still fails to make payment, then Party B reserves the right to unilaterally terminate this Contract.',
          //     }),
          //   ],
          // }),
          // //
          ...
          //   children: [
          //     new TextRun({
          //       text: '- Pay a penalty equivalent to five percent (5%) of the total outstanding Contract value; and',
          //     }),
          //   ],
          // }),
          // new Paragraph({
          ...
          //   children: [
          //     new TextRun({
          //       text: '- Indemnify Party B for any and all damages incurred as a result of such breach.',
          //     }),
          //   ],
          // }),
          // //
          ...
          // ...signinTable({
          //   partyA: {
          //     company: partyA.value,
          //     representedBy: partyADetail[0].value,
          //     position: partyADetail[1].value,
          //   },
          //   partyB: {
          //     company: partyB.value,
          //     representedBy: partyBDetail[0].value,
          //     position: partyBDetail[1].value,
          //   },
          // }),
        ],
      },
